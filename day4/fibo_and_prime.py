...
if term_number % 2  == 0:          # Checking which term it is, ie. is it fibo or prime
    terms = term_number // 2
    last_pirme_number = last_prime(terms)
    print(term_number,"th term in the 1 2 2 3 3 5 5 7 8 ... is ", last_pirme_number)
else:
    terms = (term_number // 2) + 1
    last_fibo_number = last_fibo_term(terms)
    print(term_number,"th term in the 1 2 2 3 3 5 5 7 8 ... is ", last_fibo_number )
